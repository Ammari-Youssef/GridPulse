...
import com.youssef.GridPulse.domain.inverter.settings.enums.ClcTotVaMethod;
import com.youssef.GridPulse.domain.inverter.settings.enums.ConnPhase;
import com.youssef.GridPulse.domain.inverter.settings.enums.VarAction;
...
@SuperBuilder
@Entity
@Table(indexes = {@Index(name = "idx_invSettings_history_original_id", columnList = "original_id")})
public class InvSettingsHistory extends SunSpecModelEntityHistory {
